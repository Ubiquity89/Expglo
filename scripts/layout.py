...
def get_head(title, desc):
  ...
  <title>{title} | EXPGLO BUSINESS PRIVATE LIMITED</title>
  ...
  <meta property="og:title" content="{title} | EXPGLO BUSINESS"/>
  <meta property="og:description" content="{desc}"/>
  <meta property="og:type" content="website"/>
  <meta property="og:url" content="https://expglobusiness.com"/>
...
def get_header(active='home'):
    def is_act(p):
        return 'text-brand-green font-bold' if active == p else 'hover:text-brand-green'
    ...
    <div class="max-w-7xl mx-auto">
      <nav class="bg-white/95 rounded-full shadow-lg shadow-slate-200/50 border border-slate-100 px-5 py-3 flex items-center justify-between">
        ...
        <div class="hidden lg:flex items-center space-x-7 text-sm font-semibold text-slate-700">
          <a class="{is_act('home')} transition" href="index.html">Home</a>
          <a class="{is_act('about')} transition" href="about.html">About</a>
          
          <!-- Dropdown menu -->
          <div class="relative group">
            <a href="businesses.html" class="flex items-center gap-1 {is_act('businesses')} transition py-1">
            ...
            <div class="absolute left-0 top-full pt-2 hidden group-hover:block w-64 z-50">
              <div class="bg-white rounded-2xl shadow-xl border border-slate-100 p-2 space-y-1">
                <a class="block px-4 py-2.5 text-xs font-semibold rounded-xl text-slate-700 hover:bg-emerald-50 hover:text-brand-green transition" href="fund.html">
                  <span class="block font-bold text-brand-green">EXPGLO Fund</span>
                ...
                <a class="block px-4 py-2.5 text-xs font-semibold rounded-xl text-slate-700 hover:bg-emerald-50 hover:text-brand-green transition" href="businesses.html#sutrasync">
                  <span class="block font-bold text-indigo-600">SutraSync</span>
          ...
          <a class="{is_act('events')} transition" href="events.html">Events</a>
          <a class="{is_act('news')} transition" href="news.html">News</a>
          <a class="{is_act('careers')} transition" href="careers.html">Careers</a>
          <a class="{is_act('contact')} transition" href="contact.html">Contact</a>
        </div>
      ...
      <div class="fixed inset-y-0 right-0 max-w-xs w-full bg-white shadow-2xl p-6 flex flex-col justify-between overflow-y-auto">
        <div>
          ...
          <nav class="mt-6 flex flex-col space-y-4 text-sm font-bold text-slate-800">
            ...
            <a class="{is_act('contact')}" href="contact.html">Contact Us</a></nav>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-14 border-b border-emerald-900/70">
        ...
        <div class="lg:col-span-3 space-y-4">
          <div class="flex items-center gap-2">
            <div class="w-8 h-8 rounded-lg bg-emerald-500 text-brand-gold font-black flex items-center justify-center">E</div>
        ...
        <div class="lg:col-span-3 space-y-3">
          ...
          <p class="text-xs text-emerald-100/80"><strong class="text-white">Email:</strong> hello@expglo.business</p>
          <p class="text-xs text-emerald-100/80"><strong class="text-white">Phone:</strong> +91 12345 67890</p>
